...
const {LeftChange, RightChange} = require('./models/changes')
...
const setupRouter=(router,Change)=>{
...
const leftRouter=express.Router()
const rightRouter=express.Router()

setupRouter(leftRouter, LeftChange)
setupRouter(rightRouter, RightChange)
...
app.use(morgan('tiny'))
app.use('/api/leftcol', leftRouter)
app.use('/api/rightcol', rightRouter)
